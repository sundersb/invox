...
namespace invox.Model {
    ...
    class Recourse {
        ...
        /// 3. медицинской помощи при подозрении на злокачественное новообразование или
        ///   установленном диагнозе злокачественного ново-образования (первый символ
        ///   кода основного диагноза - "C" или код основного диагноза входит в диапазон
        ///   D00-D09) и нейтропении (код основного диагноза - D70 с сопутствующим
